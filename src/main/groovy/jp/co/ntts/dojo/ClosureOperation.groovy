...
class ClosureOperation {
	 ...
	 */
	def method1() {
		Closure c = {"hello"} // = ... [Question]穴埋め問題: ここを埋めて下さい。
		return c.call()  // もしくはc()
	}
	 ...
	 */
	def method2(n) {
		Closure c = {it*2} // = ... [Question]穴埋め問題: ここを埋めて下さい。
		return c(n)
	}
	 ...
	 */
	def method4() {
		return {it**2} // [Question]穴埋め問題: ここを埋めて下さい。
	}
